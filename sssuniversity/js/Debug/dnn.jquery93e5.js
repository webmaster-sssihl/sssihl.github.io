		...
		$wrap.each(function () {
			...
			showEvent = (function (cookieId) {
				return function (event, ui) {
					dnn.dom.setCookie(cookieId, ui.index, opts.cookieDays, 'http://sssuniversity.smart-thought.com/', '', false, opts.cookieMilleseconds);
				}
			})(cookieId);
        ...
        $wrap.each(function () {
            ...
            $this.find(opts.clickToToggleSelector).click(function (e) {
                ...
                var toggle = $(this).toggleClass(opts.toggleClass).parent().next(opts.regionToToggleSelector).slideToggle(function () {
                    ...
                    dnn.dom.setCookie(id, $(this).is(':visible'), opts.cookieDays, 'http://sssuniversity.smart-thought.com/', '', false, opts.cookieMilleseconds);
                });
            });
