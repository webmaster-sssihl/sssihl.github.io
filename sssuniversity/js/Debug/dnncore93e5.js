...
function __dnn_ContainerMaxMin_OnClick(oLnk, sContentID)
{
	...
	if (oContent != null)
	{
		...
		var sCurrentFile = oBtn.src.toLowerCase().substr(oBtn.src.lastIndexOf('http://sssuniversity.smart-thought.com/'));
		var sMaxFile;
		var sMaxIcon;
		var sMinIcon;
		...
		sMaxFile = sMaxIcon.toLowerCase().substr(sMaxIcon.lastIndexOf('http://sssuniversity.smart-thought.com/'));
